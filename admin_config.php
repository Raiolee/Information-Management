...
// Add admin
if (isset($_POST['add'])) {
  // Gets the file and stores it in the images folder
  $target = "images/";
      ...
      <div class="col-2 vh-100 bg-dark text-white">
        ...
        <div class="ml-2">
          ...
          <ul class="list-unstyled">
            ...
            <li class="m-4"><a href="admin_customer_config.php" class="text-decoration-none text-light">Customers</a>
            </li>
            <li class="m-4"><a href="admin_products_config.php" class="text-decoration-none text-light">Products</a>
            </li>
          </ul>
        </div>
      </div>
          ...
          <form action="admin_config.php" method="post" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="col-md-3 mb-3">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="gender" value="Other" id="genderOther" checked>
        ...
        <div class="container mt-4 border-top p-3">
          ...
          <div class="col-10">
            <table class="table table-striped table-bordered">
              ...
              <tbody>
                <?php $userdata = array();
                $res = mysqli_query($connection, 'SELECT * FROM users WHERE user_type = "Admin"');
