        ...
        <div class="row">
            ...
            <div class="col-10">
                ...
                <div class="container mt-3">
                    ...
                    <form action="admin_supplier_config.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                ...
                <div class="container mt-4 border-top p-3">
                    ...
                    <div class="col-10">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <?php $userdata = array();
                                $res = mysqli_query($connection, 'SELECT * FROM users WHERE user_type = "Supplier"');
                                while ($userRow = mysqli_fetch_array($res, MYSQLI_ASSOC)) {
                                    $projects[] = $userRow;
                                }
                                foreach ($projects as $userRow) {
                                    ?>
                                    <form method="get" action="admin_supplier_edit.php">
                                        <tr>
                                            <td>
                                            ...
                                            <td><input type="submit" class="btn btn-secondary" name="action" value="Edit">
                                            </td>
                                            <td><input type="submit" class="btn btn-secondary" name="action" value="Delete">
                                            </td>
                                            <td><input type="hidden" name="id" value="<?php echo $userRow['user_id']; ?>" />
                                            </td>
                                        </tr>
                                    </form>
                                <?php } ?>
